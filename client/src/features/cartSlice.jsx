...
const allQuantity = localStorage.getItem("totalQuantity") != null ? JSON.parse(localStorage.getItem("totalQuantity")):0
const totalAmount = localStorage.getItem("totalPrice") != null ? JSON.parse(localStorage.getItem("totalPrice")):0
